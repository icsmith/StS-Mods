...
import static RoR_Engineer.RoR_Engineer.makeEventPath;

public class IdentityCrisisEvent extends AbstractImageEvent {


    public static final String ID = RoR_Engineer.makeID("IdentityCrisisEvent");
            ...
            case 0: // While you are on screen number 0 (The starting screen)
                switch (i) {
                    ...
                    case 3: // If you press button the fourth button (Button at index 3), in this case: TOUCH
                        imageEventText.loadImage("RoR_EngineerResources/images/events/IdentityCrisisEvent2.png"); // Change the shown image
