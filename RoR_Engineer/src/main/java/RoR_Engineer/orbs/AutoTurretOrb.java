...
public class AutoTurretOrb extends AbstractOrb {
    ...
    private static final Texture IMG = TextureLoader.getTexture(makeOrbPath("TR12_Gauss_Auto-Turret.png"));
    ...
    public void updateDescription() { // Set the on-hover description of the orb
        ...
        description = DESC[0] + passiveAmount + DESC[1] + DESC[2] + evokeAmount; // Set the description
    }
    ...
    public void onEvoke() { // 1.On Orb Evoke
        ...
        AbstractDungeon.actionManager.addToBottom( // 2. Add focus
                new ApplyPowerAction(AbstractDungeon.player, AbstractDungeon.player, new FocusPower(AbstractDungeon.player, 1), evokeAmount));
        ...
        AbstractDungeon.actionManager.addToBottom(new SFXAction("CARD_UPGRADE")); // 3.And play a Jingle Sound.
